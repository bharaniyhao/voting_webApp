...
//after sending a prompt to the user phone number entered to
function submitMissAgricultureVote($candidate)
{
    global $conn;

    // Function to submit the amount and update the points for the selected candidate
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['candidate'])) {
        ...
        submitMissAgricultureVote($candidate);
    } else {
